...
def hf_processor(name_or_path, **kwargs):
    ...
    try:
        ...
        # REVISE: keep upstream's model_class + get_vision_position_ids binding, but stay
        # permissive (try/except, hasattr guards, warn-not-raise) so non-Qwen processors
        # such as InternVL2 / LLaVA-OneVision do not crash plug-and-play evaluation.
        ...
        try:
            ...
            if model_class is not None:
                if hasattr(model_class, "get_rope_index"):
                ...
                if hasattr(model_class, "get_vision_position_ids"):
                    processor.get_vision_position_ids = types.MethodType(
                        model_class.get_vision_position_ids, processor
                    )
