...
Usage:
  python scripts/repro/bootstrap_assets.py plan
  python scripts/repro/bootstrap_assets.py models --paper-models
  python scripts/repro/bootstrap_assets.py videoespresso
  python scripts/repro/bootstrap_assets.py all
...
def step_env(asset_root: Path) -> StepResult:
    ...
    lines = ["# Source this file before running scripts/repro/doctor.py or paper_suite.py."]
